...
struct HalfModalView<Content: View> : View {
    ...
    var modalHeight : CGFloat = 400 // @Binding var isShown : Bool에 대한 가변 모달
    ...
    var body: some View{
        ...
        return Group{
            ...
            Spacer().edgesIgnoringSafeArea(/*@START_MENU_TOKEN@*/.all/*@END_MENU_TOKEN@*/)
                .frame(
                    width:UIScreen.main.bounds.size.width, // UIScreen.main.bounds.size.width/height 경계 지점 높이와 넓이를 정확히 구하는 방법 (Frame X, bounds O)
